...
The [Momentic CLI](https://github.com/momentic-ai/sdk) is a [NPM package](https://www.npmjs.com/package/momentic) that allows you to easily integrate Momentic's AI into your application and workflows.
